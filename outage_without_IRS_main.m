...
% SNRs calculation---------------------------------------------------------
        ...
        gamma_out_count_sr=gamma_out_count_sr+(gamma_star_sr<gamma_th);
    end
    outage_inst=gamma_out_count/NS;
    outageProb_sim=[outageProb_sim outage_inst];
    
    outage_inst_sr=gamma_out_count_sr/NS;
    outageProb_sim_sr=[outageProb_sim_sr outage_inst_sr];
...
semilogy(gamma_bar_db,outageProb_sim_sr,'-','color',[0 0 1],'LineWidth',2);hold on;
