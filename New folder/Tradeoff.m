...
%% Added by Dulaj
    ...
    for ll = 1:L % I have used zeta here
        ...
        E_WR2 = E_WR2 +  Path_loss_S_IRS.*Path_loss_IRS_R*(0.5 + 0.5) - pi*pi*Path_loss_S_IRS.*Path_loss_IRS_R/16; % this is not E[(W_R)^2], this is variance
        E_WI2 = E_WI2 +  Path_loss_S_IRS.*Path_loss_IRS_R*(0.5 - 0.5);
    end
